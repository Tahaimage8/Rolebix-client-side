...
const JobCard = ({ job }) => {
  ...
  return (
    <Card className="group border border-white/10 bg-[#171717] text-white shadow-2xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-violet-400/30 hover:bg-[#1b1b1b]">
      ...
      <Card.Footer className="flex items-center justify-between gap-4 border-t border-white/10 p-6 pt-5">
        ...
        <Button
          as={Link}
          href={applyHref}
          className="rounded-xl bg-white px-5 text-sm font-semibold text-black transition group-hover:bg-violet-500 group-hover:text-white"
        >
          Apply Now
